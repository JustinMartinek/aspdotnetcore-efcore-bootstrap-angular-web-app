...
namespace TheWorld.Models
{
    public class WorldContextSeedData 
    {
        ...
        public WorldContextSeedData(WorldContext context, UserManager<WorldUser> manager)
        {
            Context = context;
            UserManager = manager;
        }
        ...
        public async Task EnsureSeedData()
        {
            ...
            if(await UserManager.FindByEmailAsync("jmartinek@ddti.net") == null)
            {
                var user = new WorldUser() {
                    UserName = "jmartinek",
                    Email = "jmartinek@ddti.net"
                };
